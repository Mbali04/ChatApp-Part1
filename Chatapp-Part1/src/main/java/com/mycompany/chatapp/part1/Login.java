...
public class Login {
    ...
    */
     ...
     */
     ...
     //mMethod checksif phone number starts with southafrican international country code +27 and is 12 characters long.
...
*/
    ...
    public String registerUser(){
        ...
        if (checkUserName()){
            ...
            message += "Username is not correctly formatted; please ensure that your username contains an underscore and is no morethan five characters in length.\n";
        }
        ...
        if (checkPasswordComplexity()){
            ...
            message += "Password is not correctly formatted; please ensure that the password contains at least eight characters,a capital letter, a number, and a special characters a c";
        }
